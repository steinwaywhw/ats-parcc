...
implement fprint_token (t, out) =
    ...
    | TSpace      _  => $extfcall (void, "fprintf", out, "TSpace")
    ...
    | TUnderscore _   => $extfcall (void, "fprintf", out, "TUnderscore")
    | TColon      _   => $extfcall (void, "fprintf", out, "TColon")
    | TSemiColon  _   => $extfcall (void, "fprintf", out, "TSemiColon")
    | TComma      _   => $extfcall (void, "fprintf", out, "TComma")
    ...
    | TSym        opr => $extfcall (void, "fprintf", out, "TSym (%s)", opr)
